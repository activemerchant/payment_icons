...
4. Edit `db/payment_icons.yml` file with the id, name, label and group of your icon. We currently have credit_cards, cryptocurrencies, debit_cards, mobile_wallets, bank_transfers and other as possible group options.
